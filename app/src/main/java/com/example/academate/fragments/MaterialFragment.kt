...
import com.example.academate.Let2Os
...
//    }
    override fun onCreateView(
        ...
        val download2: ImageView = view.findViewById(R.id.down2)
        download2.setOnClickListener{
            val url = "https://firebasestorage.googleapis.com/v0/b/acadmate-f1d72." +
        ...
        val lect2: ImageView = view.findViewById(R.id.l2)
        lect2.setOnClickListener {
            val intent = Intent(requireContext(), Let2Os::class.java)
            startActivity(intent)
        }
